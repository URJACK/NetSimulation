...
public class CompilerInitial
{
    ...
    /// </summary>
    public void InitSymbolRecorder(HashSet<char> symbolSingleRecorder,HashSet<string> symbolMultipleRecorder)
    {
        symbolSingleRecorder.Add(',');
        symbolSingleRecorder.Add('.');
        symbolSingleRecorder.Add(';');
        symbolSingleRecorder.Add('{');
        symbolSingleRecorder.Add('}');
